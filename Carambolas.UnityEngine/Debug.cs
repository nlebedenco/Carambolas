...
namespace Carambolas.UnityEngine
{
    public class Debug: UnityDebug
    {
        public static class Drawer
        {
            ...
            {
                UnityEngine.Debug.DrawLine(from, to, color, duration, depthTest);
            }

            /// <summary>
            /// Draw a simple colored ray
            /// </summary>
            [Conditional("DEBUG")]
            public static void DrawRay(Vector3 from, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
            {
                UnityEngine.Debug.DrawRay(from, direction, color, duration, depthTest);
            }
            ...
            public static void DrawHumanoidSkeleton(GameObject gameObject, Color color)
            {
                ...
                string[] unityBones = System.Enum.GetNames(typeof(HumanBodyBones));
