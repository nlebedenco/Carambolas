...
cmake -G "Visual Studio 15 2017" %~dp0 -DCMAKE_INSTALL_PREFIX="../../NuGet/runtimes/win-x86"
if %errorlevel% neq 0 goto error 
popd

mkdir "%~dp0..\Build\CMake\win-x64" 
pushd "%~dp0..\Build\CMake\win-x64"
cmake -G "Visual Studio 15 2017 Win64" %~dp0 -DCMAKE_RC_FLAGS="/D_WIN64" -DCMAKE_INSTALL_PREFIX="../../NuGet/runtimes/win-x64"
if %errorlevel% neq 0 goto error 
popd
